...
function setCountDown() {
    var countDownDate = new Date("Jan 5, 2025 11:37:25").getTime();
    ...
    var x = setInterval(function () {
        ...
        if (distance < 0) {
            document.getElementById("day").innerHTML = "ja tr";
...
// Check the current path and call setCountDown if the path is /home or /home1
var currentPath = window.location.pathname;
if (currentPath === "/home" || currentPath === "/home1") {
    setCountDown();
}
